...
public class NetherChestLootTableProvider extends LootTableProvider {
    public NetherChestLootTableProvider(PackOutput output) {
        super(
                output,
                Set.of(),
                List.of(new SubProviderEntry(NetherChestLootSubProvider::new, LootContextParamSets.CHEST))
        );
    }


    private static class NetherChestLootSubProvider implements LootTableSubProvider {
        @Override
